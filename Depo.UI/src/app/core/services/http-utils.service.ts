...
export class HttpUtilsService {
	...
	baseApiUrl: string = this.url.port == null || this.url.port == '' ? this.url.origin + ':8080' : this.url.origin.replace(this.url.port, '8080');
	keepAliveTimeout: number = 30;
	keepAliveDate: Date;

	setKeepAliveDate() {
		this.keepAliveDate = new Date();
	}
