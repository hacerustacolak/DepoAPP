 ...
 */
@Component({
	selector: 'merchant-offer-file-type-autocomplete',
	templateUrl: './merchant-offer-file-type-autocomplete.component.html'
})
export class MerchantOfferFileTypeAutocompleteComponent implements OnInit {
	isLoading = false;
	isErasable = true;
	...
	constructor(private translateService: TranslateService,
		private cdr: ChangeDetectorRef) {
			this.placeholder = this.translateService.instant('CRM.MERCHANT.OFFER.FILE_TYPE');
	}
	...
	loadOptions(): any {
		let data: string[] = [];
		data.push("İmza Sürküsü");
		data.push("Sözleşme");
		data.push("Teklif Dokümanı");		
		data.push("Vergi Levhası");		
