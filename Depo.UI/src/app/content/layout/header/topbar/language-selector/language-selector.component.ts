...
export class LanguageSelectorComponent implements OnInit {
	...
	languages: LanguageFlag[] = [
		...
		//	lang: 'uk',
		//	country: 'Українська',
  //          flag: 'assets/app/media/img/flags/uk-flag.png'
		//},
		//{
		//	lang: 'az',
		//	country: 'Azerbaycan Türkçesi',
  //          flag: 'assets/app/media/img/flags/021-azerbaycan.svg'
		//}
		//,
		//{
		//	lang: 'rus',
  //          country: 'русский',
		//	flag: 'assets/app/media/img/flags/013-russia.svg'
		//}
	];
