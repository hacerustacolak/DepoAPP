...
export class LayoutConfig implements ConfigModel {
	public config: any = {
		...
		loader: {
			...
			image: './assets/demo/default/media/img/logo/logo_Depo.png'
		},
		...
		header: {
			...
			self: {
				...
				logo: {
					dark: './assets/demo/default/media/img/logo/logo_Depo.png',
					light: './assets/demo/default/media/img/logo/logo_Depo.png'
				}
			},
